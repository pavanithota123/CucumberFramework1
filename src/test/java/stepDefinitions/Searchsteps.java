...

{
	...
	
	{
		...
		home.enterproduct(validproduct);
	...
	{
		homePage home=new homePage(driver);
		home.enterproduct(invalidproduct);
	...
	
	{
	  ...
	  Assert.assertEquals("There is no product that matches the search criteria.",search.MessageText());
	}
